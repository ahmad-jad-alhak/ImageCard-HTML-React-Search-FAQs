...
var SubmitQuestionForm = function (_a) {
    ...
    var _b = useSubmitQuestion(context, siteUrl, listName), submitQuestion = _b.submitQuestion, loading = _b.loading, error = _b.error, success = _b.success;
    var _c = useState(""), question = _c[0], setQuestion = _c[1];
    var _d = useState(""), selectedCategory = _d[0], setSelectedCategory = _d[1];
    var _e = useState(false), showSuccessMessage = _e[0], setShowSuccessMessage = _e[1];
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (success) {
                        ...
                        setTimeout(function () { return setShowSuccessMessage(false); }, 3000);
                    }
                    return [2 /*return*/];
            }
        });
    ...
    return (React.createElement(Stack, { tokens: { childrenGap: 15 } },
        ...
        React.createElement("form", { onSubmit: handleSubmit },
            React.createElement(Stack, { tokens: { childrenGap: 10 } },
                ...
                React.createElement(CategoryDropdown, { categories: categories, selectedCategory: selectedCategory, onCategoryChange: onCategoryChange, label: "Select a Category" }),
